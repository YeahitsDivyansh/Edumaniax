...
const GameNav = () => {
  ...
  return (
    <div className="w-full h-[10.5vh] bg-[#28343A] flex items-center justify-between px-[2vw] relative z-10">
      ...
      <span className="lilita ml-[14vw] md:ml-[11vw] lg:ml-[7vw] [text-shadow:0_6px_0_#000] [text-stroke:1px_black] sm:text-[2.8vh] md:text-[3vh] lg:text-[4vh] text-[#ffcc00] ml-[8vw] tracking-[0.05vw]">
        Pick the Zone
      </span>
