...
import ScenarioContent from './ScenarioContext'; // Corrected the import name

const InstructionsScreen = ({ onStartGame }) => {
  return (
    // Main container to center the entire pop-up. min-h-screen allows content to grow.
    <div className="main-container bg-[#0A160E] flex flex-col items-center justify-center min-h-screen w-screen p-4">
      ...
      <div className="relative w-full max-w-3xl md:w-[75vw] h-auto md:h-[80vh] bg-[url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-08-07/WxAZj0TxFZ.png)] bg-no-repeat bg-cover flex flex-col items-center py-8 md:pt-[5vh] rounded-2xl">
        ...
        {/* Container for the main content area.
            - Mobile (default): Stacks vertically (flex-col) and centers items.
            - Desktop (md): Lays out in a row (md:flex-row) and aligns to the top.
        */}
