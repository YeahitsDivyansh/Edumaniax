    ...
    <div className="min-h-screen bg-gradient-to-br from-green-400 via-blue-500 to-purple-600 p-4 sm:p-6 lg:p-8">
      <div className="max-w-4xl mx-auto p-3">
        ...
        <div className="flex justify-center items-center">
          {/* Infrastructure Game Card */}
          <div
            onClick={() => startGame("infrastructure")}
            className="bg-gradient-to-br from-green-300 via-yellow-200 to-lime-300 rounded-3xl p-6 sm:p-8 border-4 border-green-400/50 cursor-pointer transform hover:scale-110 transition-all duration-300 hover:brightness-110 shadow-xl hover:shadow-yellow-300"
          >
            <div className="text-center">
              <div className="mb-6 flex justify-center">
                <div className="bg-yellow-400 p-4 rounded-full animate-bounce shadow-md hover:rotate-3 transition-all duration-300">
                  <Building className="w-8 h-8 sm:w-12 sm:h-12 text-green-800" />
                </div>
              </div>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-green-900 drop-shadow-md mb-4">
                Infrastructure Showdown
              </h2>
              <p className="text-green-800 mb-6 text-sm sm:text-base font-medium">
                Choose which infrastructure project contributes more to
                long-term sustainability!
              </p>
              <div className="flex items-center justify-center">
                <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-5 rounded-full flex items-center gap-2 transition-all duration-300 shadow-lg hover:shadow-green-400">
                  <span className="text-base sm:text-lg">Start Game</span>
...
export default SustainabilityGames1;
