...
const GameInfo = () => {
  const [selectedImage, setSelectedImage] = useState("/selGameInfo/ss1.png");
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-600 lg:max-w-5xl text-sm md:text-base">
          Our creativity tools, interactive story-based lessons, and relatable
          characters help students build emotional awareness, empathy, and
          responsible decision-making. Each step empowers them to grow in
          confidence, strengthen relationships, and lead with kindness and
          purpose.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 px-2">
        {[1, 2, 3, 4, 5, 6].map((num) => {
          const imgPath = `/selGameInfo/ss${num}.png`;
