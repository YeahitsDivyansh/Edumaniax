...
const GameInfo = () => {
  const [selectedImage, setSelectedImage] = useState("/lawGameInfo/ss1.png");
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      {/* Heading */}
      <div className="mb-10">
        <h2 className="text-3xl lg:max-w-5xl font-bold text-gray-900 mb-3">
          What’s in the game!
        </h2>
        <p className="text-gray-600 max-w-2xl text-sm md:text-base">
          Our creativity tools, interactive story-based lessons, and fun
          characters will motivate students to explore key legal concepts and
          take their first big steps toward understanding law, justice, and
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 px-2">
        {[1, 2, 3, 4, 5, 6].map((num) => {
          const imgPath = `/lawGameInfo/ss${num}.png`;
