    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-600 lg:max-w-5xl text-sm md:text-base">
          ...
          students dive into the world of sustainable entrepreneurship—mastering
          skills like eco-problem solving, green innovation, business modeling,
          and building ethical, impact-driven ventures that protect the planet
          and improve lives.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 px-2">
        {[1, 2, 3, 4, 5, 6].map((num) => {
          const imgPath = `/environmentGameInfo/ss${num}.png`;
